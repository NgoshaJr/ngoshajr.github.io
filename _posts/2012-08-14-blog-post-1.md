...
```
<img src="https://github.com/NgoshaJr/ngoshajr.github.io/blob/gh-pages/Blog-Post-Outputs/monthly_sst.JPG"
     alt="Monthly Sea Surface Temperature in the WIO"
     style="float: left; margin-right: 10px;" />
     
![alt text for screen readers](https://github.com/NgoshaJr/ngoshajr.github.io/blob/gh-pages/Blog-Post-Outputs/monthly_sst.JPG "Text to show on mouseover")
...
plt.show()
```
<img src="https://github.com/NgoshaJr/ngoshajr.github.io/blob/gh-pages/Blog-Post-Outputs/seasonal_sst.JPG"
     alt="Monthly Sea Surface Temperature in the WIO"
     style="float: left; margin-right: 10px;" />
####  Plot contours
```python
...
plt.show()
```
<img src="https://github.com/NgoshaJr/ngoshajr.github.io/blob/gh-pages/Blog-Post-Outputs/contours_sst.JPG"
     alt="Monthly Sea Surface Temperature in the WIO"
     style="float: left; margin-right: 10px;" />
