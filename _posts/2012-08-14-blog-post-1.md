...
```
```
### [![monthly sst in the wio](/ngoshajr.github.io/Blog-Post-Outputs/ "Monthly Trends and vaariation of sst in the wio")]
[![monthly sst in the wio](https://github.com/NgoshaJr/ngoshajr.github.io/blob/gh-pages/Blog-Post-Outputs/monthly_sst.JPG "Monthly Trends and vaariation of sst in the wio")]
```
